...
3. Budget native source and codec allocations for maps, beyond the output-pixel budget. Compact windows and capped cache fills do not provide admission control for concurrent work or codec intermediates.
